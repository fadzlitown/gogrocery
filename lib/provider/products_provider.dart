...
class ProductProvider with ChangeNotifier {
  ...
  //query first product id match to productId
  ProductModel getProductById(String productId) {
    return _productsList.firstWhere((element) => element.id == productId);
  }

  List<ProductModel> getProductByCategory(String categoryName) {
  ...
  Future<void> fetchProducts() async {
    ...
    await FirebaseFirestore.instance
      ...
      notifyListeners();
      // _productsList.insert(0, ProductModel(id: product.docs[0].get('field'), title: title, imageUrl: imageUrl,
      //     productCategoryName: productCategoryName, price: price, salePrice: salePrice, isOnSale: isOnSale, isPiece: isPiece))
    });
  }
