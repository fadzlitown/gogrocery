...
class RegisterScreen extends StatefulWidget {
  //todo used Stateful coz need to keep all the field state!!
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //TODO L - to avoid ERROR Bottom overloaded by 213 pixels , then used this on Scaffold
      body: LoadingFullscreenWidget(isLoading: _isLoading,
        child: Stack(
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFormField(
                            ...
                            onEditingComplete: () {
                              //lepas habis focus email field pulak _emailFocusNode
                            ...
                            decoration: const InputDecoration(
                                ...
                                errorBorder: UnderlineInputBorder(
                                    // when validating failed
                                    borderSide: BorderSide(color: Colors.red)),
                                enabledBorder: UnderlineInputBorder(
                                    borderSide: BorderSide(color: Colors.white)),
                                focusedBorder: UnderlineInputBorder(
                                    //when user focus on this field
