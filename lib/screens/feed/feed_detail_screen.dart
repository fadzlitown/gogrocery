...
class _FeedDetailScreenState extends State<FeedDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //todo l - WillPopScope gives us control over the back button action, allowing the current page to go back to the previous one
    return  WillPopScope(
      onWillPop: () async {
        viewedProvider.addWishItemToList(productId);
        return true;
      },
